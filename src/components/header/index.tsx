    ...
    return (
        <header className=" flex bg-gray-950 items-center spac border-b ">
            ...
            <Link
                ...
                <span className="bg-red-700 rounded-full w-full text-center text-xs font-extrabold p-1 absolute bottom-2.5 left-2.5 -scale-75 rotate-180 ">{countFavorite}</span>
